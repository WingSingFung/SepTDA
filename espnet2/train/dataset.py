...
from espnet2.fileio.msvs_json import NpyMSVSJsonReader, read_msvs_json_from_yaml
...
DATA_TYPES = {
    ...
    "npy_msvs_json": dict(
        func=NpyMSVSJsonReader,
        kwargs=[],
        help="Npy msvs json file format."
        "\n\n"
        "   [    "
        "   {'Uid': 'utterance_id_A'},"
        "   {'Uid': 'utterance_id_B'},"
